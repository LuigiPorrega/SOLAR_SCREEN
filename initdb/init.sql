...
INSERT IGNORE INTO ModelosFundas (Nombre, Tamaño, CapacidadCarga, Expansible, ImagenURL, TipoFunda) VALUES
  ('A ADDTOP Cargador Solar', '15x8 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F1.jpg', 'fija'),
  ('Saraupup Cargador Solar', '15x8 cm', 38800, FALSE, 'assets/imagenes/fundas_fijas/F2.jpg', 'fija'),
  ('Hiluckey Power Bank Solar', '17x9 cm', 26800, FALSE, 'assets/imagenes/fundas_fijas/F3.jpg', 'fija'),
  ('Riapow Power Bank Solar', '16x9 cm', 27000, FALSE, 'assets/imagenes/fundas_fijas/F4.jpg', 'fija'),
  ('Goal Zero Sherpa 100AC', '24x10 cm', 25600, FALSE, 'assets/imagenes/fundas_fijas/F5.jpg', 'fija'),
  ('Anker PowerCore Solar 20000', '15x8 cm', 20000, FALSE, 'assets/imagenes/fundas_fijas/F6.jpg', 'fija'),
  ('RAVPower Solar Power Bank', '16x9 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F7.jpg', 'fija'),
  ('Nekteck Solar Charger', '18x9 cm', 22000, FALSE, 'assets/imagenes/fundas_fijas/F8.jpg', 'fija'),
  ('Blavor Solar Power Bank', '18x10 cm', 26800, FALSE, 'assets/imagenes/fundas_fijas/F9.jpg', 'fija'),
  ('Aeiusny Solar Power Bank', '16x8 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F10.jpg', 'fija'),
  ('Maxoak K2 Solar Power Bank', '21x11 cm', 50000, FALSE, 'assets/imagenes/fundas_fijas/F11.jpg', 'fija'),
  ('X-DRAGON Solar Power Bank', '16x9 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F12.jpg', 'fija'),
  ('Solpex Power Bank Solar', '17x8 cm', 30000, FALSE, 'assets/imagenes/fundas_fijas/F13.jpg', 'fija'),
  ('Chgeek Solar Power Bank', '17x8 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F14.jpg', 'fija'),
  ('ECO-WORTHY Solar Power Bank', '15x8 cm', 26800, FALSE, 'assets/imagenes/fundas_fijas/F15.jpg', 'fija'),
  ('Poweradd Apollo 2 Solar', '15x7 cm', 20000, FALSE, 'assets/imagenes/fundas_fijas/F16.jpg', 'fija'),
  ('iMuto Portable Solar Charger', '16x9 cm', 30000, FALSE, 'assets/imagenes/fundas_fijas/F17.jpg', 'fija'),
  ('Tacklife Solar Power Bank', '18x9 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F18.jpg', 'fija'),
  ('Leechi Solar Power Bank', '16x8 cm', 24000, FALSE, 'assets/imagenes/fundas_fijas/F19.jpg', 'fija'),
  ('Vinsic Solar Power Bank', '15x7 cm', 20000, FALSE, 'assets/imagenes/fundas_fijas/F20.jpg', 'fija'),
  ('Varta Power Bank Solar', '17x9 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F21.jpg', 'fija'),
  ('Intocircuit Solar Power Bank', '15x8 cm', 26000, FALSE, 'assets/imagenes/fundas_fijas/F22.jpg', 'fija'),
  ('Tera Grand Solar Power Bank', '17x8 cm', 27000, FALSE, 'assets/imagenes/fundas_fijas/F23.jpg', 'fija'),
  ('Zeefo Solar Power Bank', '16x9 cm', 23000, FALSE, 'assets/imagenes/fundas_fijas/F24.jpg', 'fija'),
  ('Oukitel Solar Power Bank', '19x10 cm', 30000, FALSE, 'assets/imagenes/fundas_fijas/F25.jpg', 'fija'),
  ('Vintar Solar Charger', '16x9 cm', 27000, FALSE, 'assets/imagenes/fundas_fijas/F26.jpg', 'fija'),
  ('Tommy Solar Power Bank', '15x8 cm', 25000, FALSE, 'assets/imagenes/fundas_fijas/F27.jpg', 'fija'),
  ('Yunseity Solar Power Bank', '15x8 cm', 22000, FALSE, 'assets/imagenes/fundas_fijas/F28.jpg', 'fija'),
  ('DOKO Solar Power Bank', '17x9 cm', 28000, FALSE, 'assets/imagenes/fundas_fijas/F29.jpg', 'fija'),
  ('Awei Solar Charger', '16x9 cm', 24000, FALSE, 'assets/imagenes/fundas_fijas/F30.jpg', 'fija');


-- Inserción de modelos de fundas expandibles con rutas de imagen corregidas
INSERT IGNORE INTO ModelosFundas (Nombre, Tamaño, CapacidadCarga, Expansible, ImagenURL, TipoFunda) VALUES
  ('FEELLE Cargador Solar Power Bank', '20x10 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E1.jpg', 'expandible'),
  ('Riapow Power Bank Solar', '20x10 cm', 27000, TRUE, 'assets/imagenes/fundas_expandibles/E2.jpg', 'expandible'),
  ('Hiluckey 15W Power Bank Solar', '20x10 cm', 30000, TRUE, 'assets/imagenes/fundas_expandibles/E3.jpg', 'expandible'),
  ('Mesuvida 60W Solar Panel', '30x15 cm', 50000, TRUE, 'assets/imagenes/fundas_expandibles/E4.jpg', 'expandible'),
  ('Suaoki Solar Power Bank', '18x8 cm', 20000, TRUE, 'assets/imagenes/fundas_expandibles/E5.jpg', 'expandible'),
  ('ECO-WORTHY Solar Charger', '25x12 cm', 35000, TRUE, 'assets/imagenes/fundas_expandibles/E6.jpg', 'expandible'),
  ('Blavor Solar Power Bank', '18x9 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E7.jpg', 'expandible'),
  ('Nekteck Solar Charger', '19x10 cm', 22000, TRUE, 'assets/imagenes/fundas_expandibles/E8.jpg', 'expandible'),
  ('Aoyama Solar Power Bank', '18x8 cm', 27000, TRUE, 'assets/imagenes/fundas_expandibles/E9.jpg', 'expandible'),
  ('Anker PowerCore Solar 20000', '15x8 cm', 20000, TRUE, 'assets/imagenes/fundas_expandibles/E10.jpg', 'expandible'),
  ('RAVPower Solar Power Bank', '19x9 cm', 24000, TRUE, 'assets/imagenes/fundas_expandibles/E11.jpg', 'expandible'),
  ('Goal Zero Yeti Solar Generator', '50x25 cm', 100000, TRUE, 'assets/imagenes/fundas_expandibles/E12.jpg', 'expandible'),
  ('Outxe Solar Power Bank', '20x10 cm', 30000, TRUE, 'assets/imagenes/fundas_expandibles/E13.jpg', 'expandible'),
  ('X-DRAGON Solar Power Bank', '18x8 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E14.jpg', 'expandible'),
  ('Tacklife Solar Power Bank', '16x8 cm', 24000, TRUE, 'assets/imagenes/fundas_expandibles/E15.jpg', 'expandible'),
  ('Tera Grand Solar Power Bank', '20x10 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E16.jpg', 'expandible'),
  ('Maxoak Solar Power Bank', '21x11 cm', 50000, TRUE, 'assets/imagenes/fundas_expandibles/E17.jpg', 'expandible'),
  ('Solpex Solar Charger', '18x9 cm', 30000, TRUE, 'assets/imagenes/fundas_expandibles/E18.jpg', 'expandible'),
  ('Oukitel Solar Power Bank', '19x10 cm', 30000, TRUE, 'assets/imagenes/fundas_expandibles/E19.jpg', 'expandible'),
  ('Tommy Solar Power Bank', '16x8 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E20.jpg', 'expandible'),
  ('Vinsic Solar Power Bank', '18x9 cm', 22000, TRUE, 'assets/imagenes/fundas_expandibles/E21.jpg', 'expandible'),
  ('DOKO Solar Power Bank', '16x8 cm', 24000, TRUE, 'assets/imagenes/fundas_expandibles/E22.jpg', 'expandible'),
  ('Yunseity Solar Power Bank', '15x7 cm', 22000, TRUE, 'assets/imagenes/fundas_expandibles/E23.jpg', 'expandible'),
  ('Leechi Solar Power Bank', '18x9 cm', 23000, TRUE, 'assets/imagenes/fundas_expandibles/E24.jpg', 'expandible'),
  ('Chgeek Solar Power Bank', '17x8 cm', 26000, TRUE, 'assets/imagenes/fundas_expandibles/E25.jpg', 'expandible'),
  ('Awei Solar Charger', '16x9 cm', 24000, TRUE, 'assets/imagenes/fundas_expandibles/E26.jpg', 'expandible'),
  ('ECO-WORTHY Solar Power Bank', '20x10 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E27.jpg', 'expandible'),
  ('Zeefo Solar Power Bank', '18x9 cm', 23000, TRUE, 'assets/imagenes/fundas_expandibles/E28.jpg', 'expandible'),
  ('Varta Solar Power Bank', '17x8 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E29.jpg', 'expandible'),
  ('Intocircuit Solar Power Bank', '16x8 cm', 25000, TRUE, 'assets/imagenes/fundas_expandibles/E30.jpg', 'expandible'),
  ('Blavor Solar Charger', '20x10 cm', 30000, TRUE, 'assets/imagenes/fundas_expandibles/E31.jpg', 'expandible');
